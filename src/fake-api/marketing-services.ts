...
const MARKETING_SERVICES: MarketingServiceData[] = [
  {
    ...
    listingImage: '/smart-packaging-image.jpg',
    ...
    introSection: {
      ...
      image: '/smart-packaging-image.jpg',
      ...
      items: [
        {
          ...
          icon: '/tailored_icons.svg',
        },
        {
          id: 'market-share',
          title: 'Market Share',
          subtitle: 'Analysis',
          icon: '/market_share_icon.svg',
        },
        {
          id: 'consumer-behavior',
          title: 'Consumer Behavior',
          subtitle: 'Insights',
          icon: '/consumer_icons.svg',
        },
        {
          id: 'industry',
          title: 'Industry',
          subtitle: 'Industry',
          icon: '/industry_icon.svg',
        },
        {
