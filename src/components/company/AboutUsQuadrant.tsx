  ...
  return (
    <section className="w-full bg-gray-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 pt-10 md:pt-20">
        ...
        <div className="flex items-center justify-center p-5 md:p-12 lg:p-16 xl:p-16">
          <div className="max-w-2xl">
            <h2 className="text-[22px] text-black md:text-4xl lg:text-5xl font-bold mb-4 md:mb-8 leading-tight md:leading-[60px]" dangerouslySetInnerHTML={{ __html: data.bottomRight.title }} />
